return {{
    ...
    branch = "dev-v3",
    dependencies = {"HallerPatrick/py_lsp.nvim", "L3MON4D3/LuaSnip", "aznhe21/actions-preview.nvim",
                    "ray-x/lsp_signature.nvim", "saecki/crates.nvim", "simrat39/rust-tools.nvim",
    ...
    config = function()
        ...
        lsp.on_attach(function(client, buffer)
            ...
            map("go", "<CMD>Telescope lsp_type_definitions<CR>", {
            ...
            if client.name == "rust_analyzer" then
                map("<Leader>lR", "<CMD>RustRunnables<CR>", {
                    desc = "Rust Runnables"
                })
                map("<Leader>xR", "<CMD>RustDebuggables<CR>", {
        ...
        require("mason-lspconfig").setup({
            ensure_installed = {"ruff_lsp", "rust_analyzer", "lua_ls", "html", "cssls", "tsserver"},
            handlers = {
                lsp.default_setup,
                lua_ls = function()
